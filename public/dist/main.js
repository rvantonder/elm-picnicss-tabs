...
var $author$project$Main$Tab = function (a) {
	return {$: 'Tab', a: a};
};
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Attributes$id('tabC-1'),
											$rtfeldman$elm_css$Html$Styled$Attributes$type_('radio'),
											$rtfeldman$elm_css$Html$Styled$Attributes$name('tabgroupC'),
											$rtfeldman$elm_css$Html$Styled$Attributes$checked(model.tab === 1)
										]),
									_List_Nil),
									A2(
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Attributes$class('pseudo button'),
											$rtfeldman$elm_css$Html$Styled$Attributes$for('tabC-1'),
											$rtfeldman$elm_css$Html$Styled$Events$onClick(
											$author$project$Main$Tab(1))
										]),
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Attributes$id('tabC-2'),
											$rtfeldman$elm_css$Html$Styled$Attributes$type_('radio'),
											$rtfeldman$elm_css$Html$Styled$Attributes$name('tabgroupC'),
											$rtfeldman$elm_css$Html$Styled$Attributes$checked(model.tab === 2)
										]),
									_List_Nil),
									A2(
									$rtfeldman$elm_css$Html$Styled$label,
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Attributes$class('pseudo button'),
											$rtfeldman$elm_css$Html$Styled$Attributes$for('tabC-2'),
											$rtfeldman$elm_css$Html$Styled$Events$onClick(
											$author$project$Main$Tab(2))
										]),
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$text('general kenobi')
												]))
										]))
								]))
						]))
